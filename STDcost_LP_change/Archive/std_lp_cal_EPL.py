...
def EPL_merge(EPL,IIM_PLC,RF,SEK_rate,LCF):
    ...
    EPLcols = ["Item No","IRP"]
    RFcols = ["RG","RF"]
    IIMdf = pd.read_excel(IIM_PLC,usecols=IIMcols,dtype={"IPROD":str},index_col="IPROD")
    ...
    path = IIM_PLC[:-5] + "_withNEWSTDCOST.xlsx"
    IIMdf.to_excel(path,index=False)
    #print(IIMdf)
...
if __name__ == "__main__":
    ...
    IIM_HAT = r"C:\Users\jpeqz\OneDrive - Epiroc\SCX\DATA brush up\LISTPRICE&STD COST\Items_PLC\Items_newRG_inEPLHAT.xlsx"
    IIM_PSD = r"C:\Users\jpeqz\OneDrive - Epiroc\SCX\DATA brush up\LISTPRICE&STD COST\Items_PLC\Items_newRG_inEPLPSD.xlsx"
    IIM_RDD = r"C:\Users\jpeqz\OneDrive - Epiroc\SCX\DATA brush up\LISTPRICE&STD COST\Items_PLC\Items_newRG_inEPLRDD.xlsx"
